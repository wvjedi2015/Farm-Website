...
<head>
    ...
    <title>Radabaugh Farms - Gallery</title>
...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="whygranite.html">Why Us?</a>
                    </li>
                    <li>
    ...
    <div class="container">
        ...
        <div class="row">
			...
			<?php lightbox_display('img/gallery/', 'Radabaugh_Farms_Gallery'); ?>
    ...
    <footer>
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <p>Copyright &copy; RAdabaugh Farms 2017 provided by <a href="http://www.radabaughfarms.com">Radabaugh Farms, LLC</a></p>
                </div>
            </div>
        </div>
    </footer>
